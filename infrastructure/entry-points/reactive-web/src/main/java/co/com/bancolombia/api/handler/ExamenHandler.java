...
import co.com.bancolombia.usecase.ExamenUseCase;
...
public class ExamenHandler {

    private final ExamenUseCase useCase;

    public Mono<ServerResponse> findAll(ServerRequest request) {
        return ServerResponse.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(useCase.findAll(), Examen.class);
    }
    ...
    public Mono<ServerResponse> save(ServerRequest request) {
        return request.bodyToMono(Examen.class)
