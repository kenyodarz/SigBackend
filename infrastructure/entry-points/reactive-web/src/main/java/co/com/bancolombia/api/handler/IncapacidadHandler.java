...
import co.com.bancolombia.usecase.IncapacidadUseCase;
...
public class IncapacidadHandler {

    private final IncapacidadUseCase useCase;

    public Mono<ServerResponse> findAll(ServerRequest request) {
        return ServerResponse.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(useCase.findAll(), Incapacidad.class);
    }
    ...
    public Mono<ServerResponse> save(ServerRequest request) {
        return request.bodyToMono(Incapacidad.class)
